...
export const AMBIENTI_AUDIO = [
  ...
  { id: 'mare', nome: '🌊 Mare', icona: '🌊', desc: 'Risacca e onde lente sulla spiaggia' },
  { id: 'montagna', nome: '⛰️ Montagna', icona: '⛰️', desc: 'Vento d’alta quota, sereno di giorno e cupo di notte' },
  { id: 'pioggia', nome: '🌧️ Pioggia', icona: '🌧️', desc: 'Pioggia battente e tuoni lontani' },
...
// Estensione del file per ambientazione (default: mp3).
const ESTENSIONE_FILE = {};
