...
const SPIEG_INCANTESIMI = {
  'Aggiustare': 'Ripari un piccolo oggetto rotto o danneggiato. (Trucchetto)',
  'Aiuto': 'Aumenti PF massimi e attuali fino a 3 creature.',
  'Ammaliare Persone': 'Affascini un umanoide, che ti considera amichevole.',
  'Animare Morti': 'Rianimi ossa o cadaveri come scheletri/zombie sotto il tuo controllo.',
  'Arma Elementale': "Un'arma ottiene bonus a colpire e danni elementali extra.",
  'Arma Magica': "Un'arma diventa magica con bonus a colpire e ai danni.",
  'Arma Spirituale': "Crei un'arma spettrale fluttuante che attacca a distanza.",
  'Armatura Magica': 'Avvolgi una creatura in una forza protettiva (CA base 13 + DES).',
  'Armatura di Agathys': 'PF temporanei; ferisci col gelo chi ti colpisce in mischia.',
  'Arte Druidica': 'Piccoli effetti naturali: prevedere il tempo, far sbocciare fiori. (Trucchetto)',
  'Aura di Vita': "Un'aura protegge dal necrotico e impedisce di scendere a 0 PF.",
  'Aura di Vitalità': "Un'aura ti permette di curare un alleato ogni turno.",
  'Bacche Nutrienti': 'Crei bacche che nutrono e curano 1 PF ciascuna.',
  'Barriera contro la Morte': 'La prima volta che la creatura scenderebbe a 0 PF, resta a 1.',
  'Bastone Incantato': 'Un bastone/clava usa Saggezza e infligge più danni. (Trucchetto)',
  'Benedizione': 'Fino a 3 alleati aggiungono 1d4 ad attacchi e tiri salvezza.',
  'Blocca Mostri': 'Paralizzi una creatura (TS Saggezza).',
  'Blocca Persone': 'Paralizzi un umanoide (TS Saggezza).',
  'Braccia di Hadar': 'Tentacoli oscuri colpiscono intorno a te e impediscono reazioni.',
  'Bussare': 'Apri magicamente una serratura, un chiavistello o una porta sbarrata.',
  'Caduta Morbida': 'Come reazione, riduci o annulli i danni da caduta di una creatura.',
  'Camuffarsi': 'Alteri il tuo aspetto (viso, vestiti, altezza) per travestirti.',
  'Cerchio di Potere': "Un'aura dà agli alleati vantaggio ai TS e dimezza certi danni.",
  'Chiamare il Fulmine': 'Evochi una nube che scaglia fulmini ogni turno.',
  'Colonna di Fuoco': 'Colonna di fiamme divine ad area (metà fuoco, metà radioso).',
  'Colpo Accecante': 'Il prossimo colpo infligge radioso extra e può accecare.',
  'Colpo Ardente': 'Il prossimo colpo infligge fuoco extra e incendia il bersaglio.',
  'Colpo Intrappolante': 'Il prossimo colpo intrappola il bersaglio con rovi.',
  'Colpo Irato': 'Il prossimo colpo infligge necrotico extra e spaventa.',
  'Colpo Marchiante': 'Il prossimo colpo marchia il bersaglio, rendendolo visibile.',
  'Colpo Sconvolgente': 'Il prossimo colpo infligge psichico extra e sconvolge il bersaglio.',
  'Colpo Sicuro': 'Ottieni vantaggio al tuo prossimo tiro per colpire. (Trucchetto)',
  'Colpo Tonante': 'Il prossimo colpo infligge tuono extra e può spingere via.',
  'Comando': 'Imponi un ordine di una parola che il bersaglio deve eseguire.',
  'Comprendere Linguaggi': 'Capisci qualsiasi lingua parlata o scritta.',
  'Comunione con la Natura': 'Ottieni conoscenza del territorio circostante.',
  'Confusione': "Le creature in un'area agiscono in modo casuale e incontrollato.",
  'Cono di Freddo': 'Un cono di aria gelida infligge ingenti danni da freddo.',
  'Controincantesimo': "Come reazione, interrompi l'incantesimo che una creatura sta lanciando.",
  'Cordone di Frecce': "Frecce piantate a terra colpiscono chi entra nell'area.",
  'Corona della Follia': 'Costringi una creatura ad attaccare i suoi alleati.',
  'Crescita Vegetale': 'Fai crescere la vegetazione, rallentando chi la attraversa.',
  'Crescita di Spine': 'Copri il terreno di spine: terreno difficile che ferisce.',
  'Cura Ferite': 'Tocchi una creatura e le ripristini punti ferita.',
  'Cura Ferite di Massa': "Curi punti ferita a più creature in un'area.",
  'Dardo Guida': 'Un dardo di luce colpisce e dà vantaggio al prossimo attacco contro il bersaglio.',
  'Dardo Incantato': 'Tre dardi di forza colpiscono automaticamente i bersagli.',
  'Dardo Incantato Superiore': 'Versione potenziata di Dardo Incantato, con più dardi.',
  'Dardo Infuocato': 'Scagli una fiammata che infligge fuoco a distanza. (Trucchetto)',
  'Derisione Crudele': 'Insulti magici: danni psichici e svantaggio al prossimo attacco. (Trucchetto)',
  'Dissolvi Magie': 'Termini gli effetti magici su una creatura, oggetto o area.',
  'Dominare Persone': 'Prendi il controllo delle azioni di un umanoide.',
  'Eroismo': 'Immune alla paura e PF temporanei ogni turno.',
  'Esilio': 'Bandisci temporaneamente una creatura su un altro piano.',
  'Evocare Animali': 'Evochi spiriti bestiali che combattono per te.',
  'Evocare Elementale': 'Evochi un elementale che combatte per te.',
  'Falsa Vita': 'Ottieni punti ferita temporanei.',
  'Fame di Hadar': 'Crei una zona di vuoto affamato che danneggia e indebolisce.',
  'Faretra Veloce': 'Scocchi più frecce ogni turno come azione bonus.',
  'Faro di Speranza': 'Gli alleati hanno vantaggio ai TS su Saggezza e alla morte, e curano il massimo.',
  'Favore Divino': "La tua arma infligge danni radiosi extra.",
  'Fiamma Sacra': 'Una fiamma radiosa colpisce un nemico (TS Destrezza). (Trucchetto)',
  'Frantumare': "Un'onda sonora dannosa colpisce un'area.",
  'Freccia Fulminante': 'Il prossimo tiro con arco infligge fulmine ad area.',
  'Frusta di Spine': 'Una frusta di rovi colpisce e trascina un nemico. (Trucchetto)',
  'Fulmine': 'Una saetta lineare colpisce le creature sul suo percorso.',
  'Fulmine Stregato': 'Un raggio continuo colpisce un bersaglio ogni turno.',
  'Fuoco Fatato': "Le creature in un'area si illuminano: attacchi con vantaggio contro di loro.",
  'Guardiani Spirituali': 'Spiriti protettivi ti circondano e feriscono i nemici vicini.',
  'Guardiano della Fede': 'Un guardiano spettrale ferisce i nemici che si avvicinano.',
  'Guida': 'Aggiungi 1d4 a una prova di caratteristica. (Trucchetto)',
  'Identificare': 'Scopri le proprietà magiche di un oggetto o incantesimo.',
  'Illusione Minore': "Crei un suono o un'immagine illusoria. (Trucchetto)",
  'Immagine Maggiore': 'Illusione realistica con suoni, odori e temperatura.',
  'Immagine Silenziosa': 'Crei un\'immagine illusoria puramente visiva.',
  'Immagine Speculare': 'Copie illusorie di te che confondono gli attacchi.',
  'Individuazione dei Pensieri': 'Leggi i pensieri superficiali delle creature vicine.',
  'Individuazione del Magico': 'Percepisci la presenza e la scuola della magia vicina.',
  'Infliggere Ferite': 'Un tocco di energia negativa infligge molti danni necrotici.',
  'Infliggere Maledizione': 'Maledici una creatura con vari effetti a scelta.',
  'Interdizione alle Lame': 'Indebolisci gli attacchi con armi del bersaglio. (Trucchetto)',
  'Intralciare': "Erbacce afferrano e trattengono le creature in un'area.",
  'Invisibilità': 'Una creatura diventa invisibile finché non attacca o lancia un incantesimo.',
  'Invisibilità Superiore': 'Resta invisibile anche attaccando o lanciando incantesimi.',
  'Legame di Protezione': "Condividi i danni di un alleato: metà li subisci tu.",
  'Lentezza': 'Rallenti fino a 6 creature (velocità e azioni ridotte).',
  'Levitazione': 'Sollevi verticalmente una creatura o un oggetto.',
  'Libertà di Movimento': 'Ti muovi senza essere ostacolato da terreno difficile o blocchi.',
  'Linguaggi': "Una creatura capisce e parla qualsiasi lingua per un'ora.",
  'Localizzare Oggetto': 'Percepisci la direzione di un oggetto noto vicino.',
  'Luce': 'Fai brillare un oggetto come una torcia. (Trucchetto)',
  'Luce del Giorno': "Crei una vasta area di luce intensa.",
  'Luci Danzanti': 'Crei fino a 4 luci fluttuanti controllabili. (Trucchetto)',
  'Malanno': 'Danni necrotici che appassiscono anche le piante.',
  'Malocchio': 'Maledici un bersaglio: danni extra e svantaggio a una caratteristica.',
  'Mani Brucianti': "Un ventaglio di fiamme colpisce l'area davanti a te.",
  'Mano Magica': 'Una mano spettrale manipola oggetti a distanza. (Trucchetto)',
  'Manto del Crociato': "Un'aura di luce dà agli alleati danni radiosi extra.",
  'Marchio del Cacciatore': 'Marchi un nemico: danni extra e vantaggio a tracciarlo.',
  'Messaggio': 'Sussurri un messaggio udibile solo dal bersaglio. (Trucchetto)',
  'Messaggio a Distanza': 'Invii un breve messaggio a una creatura nota ovunque si trovi.',
  'Metallo Rovente': 'Arroventi un oggetto di metallo, ustionando chi lo tiene.',
  'Morsa del Gelo': 'Tocco gelido a distanza: danni e niente reazioni. (Trucchetto)',
  'Muro di Forza': 'Crei un muro invisibile e quasi indistruttibile.',
  'Muro di Fuoco': 'Crei un muro di fiamme che brucia chi lo attraversa.',
  'Muro di Pietra': 'Crei un muro di pietra solida.',
  'Muro di Vento': 'Una raffica verticale devia proiettili e gas.',
  'Nube Mefitica': "Una nube di gas velenoso danneggia chi vi resta.",
  'Nube di Nebbia': "Crei un'area di nebbia che oscura la vista.",
  'Offuscamento': 'Il tuo corpo appare sfocato: attacchi con svantaggio contro di te.',
  'Onda Distruttrice': "Un'onda divina danneggia (tuono + radioso/necrotico) e atterra i nemici.",
  'Onda Tonante': "Un'onda sonora respinge e danneggia le creature vicine.",
  'Oscurità': "Crei un'area di oscurità magica impenetrabile alla scurovisione.",
  'Palla di Fuoco': 'Sfera esplosiva: ingenti danni da fuoco ad area.',
  'Parlare con gli Animali': 'Comunichi con le bestie.',
  'Parola di Guarigione': 'Curi una creatura a distanza come azione bonus.',
  'Parola di Guarigione di Massa': 'Curi più creature a distanza come azione bonus.',
  'Passo Arboreo': "Ti sposti da un albero all'altro istantaneamente.",
  'Passo Lontano': 'Come azione bonus, ti teletrasporti a breve distanza.',
  'Passo Lungo': 'Aumenti la velocità di una creatura.',
  'Passo Senza Tracce': 'Tu e gli alleati diventate difficili da seguire e più furtivi.',
  'Passo Velato': 'Come azione bonus, ti teletrasporti a breve distanza.',
  'Paura': 'I nemici in un cono fuggono spaventati.',
  'Pelle Coriacea': 'La CA base di una creatura sale a 16.',
  'Pelle di Pietra': 'La creatura resiste ai danni fisici non magici.',
  'Piaga di Insetti': "Uno sciame di insetti danneggia chi resta nell'area.",
  'Pioggia di Spine': 'Il prossimo tiro con arco crea una pioggia di spine ad area.',
  'Polimorfia': 'Trasformi una creatura in una bestia.',
  'Porta Dimensionale': 'Ti teletrasporti (e un alleato) a media distanza.',
  'Potenziare Caratteristica': 'Vantaggio alle prove di una caratteristica (o altri benefici).',
  'Preghiera di Guarigione': 'Curi fino a 6 creature con un rito di 10 minuti.',
  'Presagio': "Ricevi un presagio (bene/male) su un'azione entro 30 minuti.",
  'Prestidigitazione': 'Piccoli trucchi magici innocui. (Trucchetto)',
  'Produrre Fiamma': 'Una fiamma sulla mano illumina e può essere lanciata. (Trucchetto)',
  'Protezione dal Male e dal Bene': 'Proteggi una creatura da certi tipi di mostri.',
  'Protezione dal Veleno': 'Neutralizzi un veleno e dai resistenza/vantaggio contro il veleno.',
  'Raffica Occulta': 'Uno o più raggi di forza colpiscono a distanza. (Trucchetto)',
  'Raggio Rovente': 'Tre raggi di fuoco colpiscono uno o più bersagli.',
  'Raggio dell’Indebolimento': 'Un raggio dimezza i danni in mischia del bersaglio.',
  'Raggio di Gelo': 'Un raggio gelido danneggia e rallenta. (Trucchetto)',
  'Raggio di Luna': "Un raggio di luce lunare danneggia chi vi resta.",
  'Ragnatela': "Riempi un'area di ragnatele appiccicose che trattengono.",
  'Rappresaglia Infernale': 'Come reazione, colpisci col fuoco chi ti ha ferito.',
  'Resistenza': 'Aggiungi 1d4 a un tiro salvezza. (Trucchetto)',
  'Respirare sott’acqua': "Fino a 10 creature respirano sott'acqua.",
  'Rianimare Morti': 'Riporti in vita una creatura morta da non più di 10 giorni.',
  'Ridestare': 'Doni intelletto e linguaggio a una bestia o pianta.',
  'Rimuovi Maledizione': 'Elimini le maledizioni da una creatura o oggetto.',
  'Rintocco Funebre': 'Rintocchi dannosi su un bersaglio ferito. (Trucchetto)',
  'Ristorare Inferiore': 'Curi una malattia o una condizione (paralizzato, avvelenato, ecc.).',
  'Ristorare Superiore': 'Rimuovi condizioni gravi, maledizioni o riduzioni permanenti.',
  'Ritirata Veloce': 'Come azione bonus, aumenti la velocità e Scatti ogni turno.',
  'Rivitalizzare': 'Riporti in vita una creatura morta da meno di 1 minuto.',
  'Rovina': 'Fino a 3 creature sottraggono 1d4 ad attacchi e tiri salvezza.',
  'Santuario': 'Chi attacca la creatura protetta deve superare un TS.',
  'Schema Ipnotico': 'Un disegno illusorio affascina e incanta i nemici.',
  'Scrutare': 'Osservi a distanza una creatura o un luogo con un sensore magico.',
  'Scudo': 'Come reazione, +5 alla CA e blocchi Dardo Incantato.',
  'Scudo della Fede': 'Una creatura ottiene +2 alla CA.',
  'Scudo di Fuoco': 'Ti avvolgi di fiamme: resistenza e danni a chi ti colpisce.',
  'Scurovisione': 'Doni a una creatura la capacità di vedere al buio.',
  'Servitore Invisibile': 'Evochi una forza invisibile che svolge compiti semplici.',
  'Sfera Cromatica': 'Lanci una sfera di un tipo di danno elementale a scelta.',
  'Sfera Infuocata': 'Una sfera di fuoco controllabile rotola e brucia i nemici.',
  'Silenzio': "Crei un'area di totale silenzio (niente incantesimi verbali).",
  'Sonno': 'Fai addormentare creature per un totale di punti ferita.',
  'Spruzzo di Veleno': 'Un soffio tossico danneggia un bersaglio vicino. (Trucchetto)',
  'Stabilizzare': 'Stabilizzi una creatura morente (a 0 PF). (Trucchetto)',
  'Suggestione': "Suggerisci un corso d'azione ragionevole che il bersaglio segue.",
  'Sussurri Dissonanti': 'Sussurri dolorosi feriscono e fanno fuggire il bersaglio.',
  'Sviare': 'Crei un tuo doppio illusorio e diventi invisibile, scambiandovi.',
  'Taumaturgia': 'Piccoli prodigi divini: voce tonante, tremori, porte. (Trucchetto)',
  'Telecinesi': 'Sposti creature o oggetti con la forza del pensiero.',
  'Tempesta di Ghiaccio': "Grandine e freddo colpiscono un'ampia area.",
  'Tempesta di Nevischio': "Nevischio ghiacciato oscura e rende scivolosa un'area.",
  'Terreno Allucinatorio': "Fai apparire un'area come un tipo di terreno diverso.",
  'Tocco Folgorante': 'Un tocco elettrico danneggia e impedisce reazioni. (Trucchetto)',
  'Tocco Vampirico': 'Un tocco necrotico danneggia il nemico e cura te.',
  'Trovare Destriero': 'Evochi una cavalcatura fedele legata a te.',
  'Vampa': 'Fiamme avvolgono un nemico e possono estendersi a un secondo. (Trucchetto)',
  'Vedere Invisibilità': 'Vedi le creature e gli oggetti invisibili.',
  'Velocità': "Raddoppi la velocità di un alleato e gli dai un'azione extra e +2 CA.",
  'Vite Afferrante': 'Una vite afferra e trascina un bersaglio.',
  'Volare': 'Una creatura ottiene una velocità di volo.',
