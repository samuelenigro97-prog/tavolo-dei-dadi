...
export const INCANTESIMI_CLASSE = {
  ...
  druido: {
    0: ['Artificio Druidico', 'Guida', 'Riparare', 'Spruzzo Velenoso', 'Produrre Fiamma', 'Resistenza', 'Randello Incantato', 'Frusta di Spine'],
    ...
    2: ['Pelle Coriacea', 'Sfera Infuocata', 'Raggio di Luna', 'Metallo Rovente', 'Passare Senza Tracce', 'Crescita di Spine', 'Ristorare Inferiore', 'Blocca Persone'],
    ...
    4: ['Metamorfosi', 'Tempesta di Ghiaccio', 'Pelle di Pietra', 'Muro di Fuoco', 'Libertà di Movimento'],
