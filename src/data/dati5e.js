...
export const INCANTESIMI_CLASSE = {
  ...
  druido: {
    ...
    4: ['Metamorfosi', 'Tempesta di Ghiaccio', 'Pelle di Pietra', 'Muro di Fuoco', 'Libertà di Movimento', 'Inaridire', 'Confusione', 'Controllare Acqua', 'Dominare Bestie', 'Evocare Elementali Minori', 'Evocare Creature Boschive', 'Evocare Animali Minori', 'Insetto Gigante', 'Malanno', 'Terreno Allucinatorio', 'Vite Afferrante'],
