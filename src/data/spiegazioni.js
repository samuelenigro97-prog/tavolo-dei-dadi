...
const SPIEG_INCANTESIMI = {
  ...
  'Colpo Sicuro': 'Ottieni vantaggio al tuo prossimo tiro per colpire in mischia questo turno.',
  ...
  'Interdizione alle Lame': 'Un nemico entro 1,5 m ha −1d10 ai tiri per colpire con arma (TS Costituzione).',
  ...
  'Resistenza': 'Aggiungi 1d4 a un tiro salvezza a scelta. Concentrazione, 1 min.',
  ...
  'Stregoneria Esplosiva': 'Attacco a distanza (36m): 1d8 danni (scegli acido, freddo, fuoco, fulmine, veleno o tuono). Se tiri un 8 sul d8, tiri un altro d8 e lo sommi ai danni (può succedere più volte). (Aumenta di 1d8 al 5°/11°/17°).',
