...
const SPIEG_PRIVILEGI = {
  ...
  // Stregone
  'Stregoneria innata': "**Stregoneria Innata (1° Livello)**\nLa magia scorre naturale nelle tue vene, dono di un blocco di stirpe, di un influsso ultraterreno o di una singolarità cosmica. Scegli un'Origine Stregonesca (es. Draconica, Magia Selvaggia, Aberrante, Meccanica) che determina i tuoi poteri unici fin dal 1° livello e ti concede privilegi aggiuntivi al 3°, 6°, 14° e 18° livello.",
  'Origine stregonesca': "**Origine Stregonesca (1° Livello - D&D 2014)**\nScegli la fonte del tuo potere magico innato, come la Stirpe Draconica o la Magia Selvaggia. Questa scelta ti concede privilegi specifici al 1°, 6°, 14° e 18° livello.",
  'Fonte di magia': "**Fonte di Magia (2° Livello)**\nAttingi a un pozzo interiore di energia magica rappresentato dai **Punti Stregoneria** (pari al tuo livello da Stregone).\n\n- **Creare Slot:** Come azione bonus puoi spendere Punti Stregoneria per creare slot incantesimo (1° liv = 2 pt, 2° = 3 pt, 3° = 5 pt, 4° = 6 pt, 5° = 7 pt).\n- **Convertire Slot:** Come azione bonus puoi sacrificare uno slot incantesimo per guadagnare Punti Stregoneria pari al livello dello slot.\n- I Punti Stregoneria non possono mai superare il tuo massimo e si ricaricano al termine di un riposo lungo.",
  'Metamagia': "**Metamagia (2°/3° Livello)**\nLa tua comprensione intuitiva degli incantesimi ti permette di plasmarli in base alle tue necessità.\n\n- Impari **2 opzioni** di Metamagia a scelta (ne impari altre due al 10° e una al 17° livello).\n- Quando lanci un incantesimo, spendi Punti Stregoneria per applicare un'opzione di Metamagia (puoi applicare una sola opzione per incantesimo, tranne per *Potenziato* e *Preciso*).",
  'Recupero stregonesco': "**Recupero Stregonesco (5° Livello - D&D 2024)**\nQuando completi un riposo breve, puoi recuperare un numero di Punti Stregoneria spesi pari alla metà del tuo livello da Stregone (arrotondato per difetto). Puoi usare questo privilegio una sola volta per riposo lungo.",
  'Ristoro stregonesco': "**Ristoro Stregonesco (20° Livello - D&D 2014)**\nAl 20° livello, recuperi 4 Punti Stregoneria spesi ogni volta che termini un riposo breve.",
  'Stregoneria incarnata': "**Stregoneria Incarnata (7° Livello - D&D 2024)**\nNel momento in cui usi la tua Stregoneria Innata, puoi spendere 2 Punti Stregoneria per potenziarla per 1 minuto, ottenendo i benefici specifici della tua sottoclasse (es. volo, difese aggiuntive o aure di caos) e la capacità di lanciare 2 incantesimi a turno (uno come azione e uno come azione bonus se sono del tempo di lancio corretto).",
  'Apoteosi arcana': "**Apoteosi Arcana (20° Livello - D&D 2024)**\nSei diventato una fusione vivente con la magia arcana. Una volta per turno, quando applichi un'opzione di Metamagia a un incantesimo, il costo in Punti Stregoneria di quell'opzione è ridotto di 2 (minimo 0, rendendo le opzioni da 1 e 2 punti completamente gratuite).",
  // Warlock
  ...
  'Ondata di Magia Selvaggia': "**Ondata di Magia Selvaggia (3° Livello - Magia Selvaggia)**\nLa tua magia è indomabile e caotica.\n\n- Ogni volta che lanci un incantesimo da Stregone di 1° livello o superiore, il DM può richiederti di tirare un d20.\n- Se ottieni 1 (o se hai usato Onde di Caos), tiri sulla tabella dell'Ondata di Magia Selvaggia per creare un effetto magico casuale ed esplosivo.",
  'Onde di Caos': "**Onde di Caos (3° Livello - Magia Selvaggia)**\nPuoi manipolare le forze del caso per ottenere Vantaggio a un tiro per colpire, una prova di caratteristica o un tiro salvezza.\n\n- Una volta utilizzato, devi completare un riposo lungo prima di poterlo usare di nuovo.\n- Tuttavia, prima della fine del riposo, se lanci un incantesimo da Stregone di 1° livello o superiore, il DM può farti tirare sulla tabella della Magia Selvaggia: appena lo fai, recuperi immediatamente l'uso di Onde di Caos.",
  'Piega la Sorte': "**Piega la Sorte (6° Livello - Magia Selvaggia)**\nHai la capacità di torcere il destino a tuo favore o contro i tuoi nemici. Quando una creatura che puoi vedere entro 18 metri fa un tiro per colpire, una prova di abilità o un tiro salvezza, puoi usare la tua reazione e spendere da 1 a 3 Punti Stregoneria per tirare un numero di 1d4 pari ai punti spesi e aggiungere o sottrarre il totale al tiro della creatura.",
  'Caos Controllato': "**Caos Controllato (14° Livello - Magia Selvaggia)**\nOttieni un minimo di controllo sulle esplosioni di caos arcano. Ogni volta che tiri sulla tabella dell'Ondata di Magia Selvaggia, puoi tirare due volte e scegliere quale dei due effetti applicare.",
  'Bombardamento Magico': "**Bombardamento Magico (18° Livello - Magia Selvaggia)**\nL'energia caotica infonde i tuoi incantesimi di forza distruttiva. Quando tiri i danni per un incantesimo e ottieni il valore massimo su uno qualsiasi dei dadi, puoi scegliere uno di quei dadi, tirarlo di nuovo e sommarne il risultato al danno totale dell'incantesimo (puoi farlo una volta per turno).",
  'Resilienza Draconica': "**Resilienza Draconica (3° Livello - Draconico)**\nLa magia del drago scorre nel tuo corpo, rendendolo più resistente.\n\n- I tuoi Punti Ferita massimi aumentano di 3, e aumentano di 1 ulteriore punto per ogni livello da Stregone che ottieni successivamente.\n- Inoltre, parti del tuo corpo sono coperte da un sottile strato di scaglie draconiche: quando non indossi un'armatura, la tua Classe Armatura (CA) è pari a **13 + il tuo modificatore di Destrezza**.",
  'Incantesimi Draconici': "**Incantesimi Draconici (3° Livello - Draconico)**\nLa tua stirpe ti concede incantesimi specifici connessi alla natura dei draghi (es. Comando, Scudo, Crescita di Spine, Volare) che sono sempre preparati e non contano nel numero massimo di incantesimi preparati.",
  'Affinità Elementale': "**Affinità Elementale (6° Livello - Draconico)**\nQuando lanci un incantesimo che infligge danni del tipo associato al tuo antenato draconico (acido, freddo, fuoco, fulmine o veleno), puoi aggiungere il tuo modificatore di Carisma a un tiro di danno di quell'incantesimo. Inoltre, puoi spendere 1 Punto Stregoneria per ottenere Resistenza a quel tipo di danno per 1 ora.",
  'Ali di Drago': "**Ali di Drago (14° Livello - Draconico)**\nCome azione bonus, puoi far spuntare dalla tua schiena un paio di ali draconiche magiche, ottenendo una velocità di volo pari alla tua velocità di camminare. Le ali durano finché non le ritiri con un'azione bonus.",
  'Compagno Draconico': "**Presenza Draconica / Compagno (18° Livello - Draconico)**\nIncarni il maestoso terrore dei draghi antichi. Puoi spendere 5 Punti Stregoneria come azione per emanare un'aura di terrore o fascino di 18 metri per 1 minuto, costringendo le creature nemiche a un Tiro Salvezza su Saggezza.",
  'Linguaggio Telepatico': "**Linguaggio Telepatico (3° Livello - Aberrante)**\nPuoi stabilire un contatto telepatico con una creatura entro 9 metri da te che tu possa vedere. La comunicazione è bidirezionale e dura un numero di minuti pari al tuo livello da Stregone.",
  'Incantesimi Psionici': "**Incantesimi Psionici (3° Livello - Aberrante)**\nLa tua mente toccata dal Reame Remoto ti concede incantesimi psionici (es. Tentacoli Neri, Individuazione dei Pensieri, Blocco di Persona) che sono sempre preparati per te.",
  'Stregoneria Psionica': "**Stregoneria Psionica (6° Livello - Aberrante)**\nQuando lanci un incantesimo della tua lista di Incantesimi Psionici, puoi lanciarlo spendendo Punti Stregoneria pari al livello dello slot invece di usare uno slot incantesimo. Se lo fai, l'incantesimo non richiede alcuna componente verbale, somatica o materiale (a meno che non venga consumata).",
  'Difese Psichiche': "**Difese Psichiche (6° Livello - Aberrante)**\nLa tua mente aliena è impenetrabile per i comuni mortali. Ottieni Resistenza ai danni psichici e Vantaggio nei Tiri Salvezza contro la condizione Affascinato o Spaventato.",
  'Rivelazione nella Carne': "**Rivelazione nella Carne (14° Livello - Aberrante)**\nCome azione bonus puoi spendere 1 o più Punti Stregoneria per trasformare il tuo corpo per 10 minuti, ottenendo vantaggi come vista al buio magica, velocità di nuoto/volo, o un corpo flessibile in grado di passare attraverso spazi di 2.5 cm.",
  'Implosione Distorcente': "**Implosione Distorcente (18° Livello - Aberrante)**\nCome azione, puoi scatenare una gravità distorcente dal tuo corpo, teletrasportandoti fino a 36 metri in uno spazio vuoto che puoi vedere, e costringendo le creature entro 9 metri dal punto di partenza a subire 3d10 danni di forza e ad essere attirate verso quel punto.",
  'Magia Meccanica': "**Magia Meccanica (3° Livello - Meccanico)**\nAttingi all'ordine cosmico di Mechanus, ottenendo incantesimi legati alla legge, all'equilibrio e al calcolo (es. Allineare Arma, Scudo, Aiuto) sempre preparati.",
  'Ripristinare l’Equilibrio': "**Ripristinare l’Equilibrio (3° Livello - Meccanico)**\nQuando una creatura entro 18 metri da te che puoi vedere sta per fare un tiro del d20 con Vantaggio o Svantaggio, puoi usare la tua reazione e spendere 1 Punto Stregoneria per neutralizzare il Vantaggio o Svantaggio, costringendola a tirare un solo d20 normale.",
  ...
  'Seguace Draconico': "**Presenza / Seguace Draconico (18° Livello - Draconico)**\nIncarni la potenza imperiale dei draghi. Spendi 5 Punti Stregoneria per emanare un'aura di terrore e maestosità entro 18 metri per 1 minuto, dominando il campo di battaglia.",
  ...
  'Incantesimi Meccanici': "**Incantesimi Meccanici (3° Livello - Meccanico)**\nLa tua connessione all'assoluto ordine cosmico ti concede incantesimi di protezione e precisione sempre preparati.",
...
const SPIEG_TALENTI = {
  ...
  'Guaritore': "**Guaritore (Talento)**\n*Sei un medico esperto, capace di suturare ferite e rianimare i caduti in modo rapido ed efficace.*\n\n- **Medico Rapidissimo / Rianimare (2014 & 2024):** Quando usi un kit da guaritore per stabilizzare una creatura morente, quella creatura recupera immediatamente 1 Punto Ferita.\n- **Pronto Soccorso (2014):** Come azione, puoi spendere un uso di un kit da guaritore per curare una creatura di **1d6 + 4 Punti Ferita + un numero di PF pari al numero di Dadi Vita massimi della creatura**. Una creatura non può recuperare PF in questo modo più di una volta per riposo breve o lungo.\n- **Cura di Battaglia (2024):** Quando usi il kit da guaritore, puoi spendere uno dei Dadi Vita della creatura per farle recuperare PF pari al risultato del dado + il suo modificatore di Costituzione + il tuo bonus di competenza.\n- **Rianimazione Migliorata (2024):** Ogni volta che lanci un incantesimo di guarigione o usi un kit, puoi ritirare gli 1 sui dadi di cura.",
