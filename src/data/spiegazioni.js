...
const SPIEG_INCANTESIMI = {
  'Aggiustare': 'Ripari un oggetto rotto o una crepa non più larga di ~30 cm (tocco, istantaneo).',
  ...
  'Arte Druidica': 'Piccoli effetti naturali: prevedere il meteo 24 h, far sbocciare un fiore, creare un simbolo di fumo.',
  ...
  'Randello Incantato': 'Liv. 0 · Il legno di una clava o bastone usa la caratteristica da incantatore per tiri e danni (1d8 contundente). 1 min.',
  'Bastone Incantato': 'Liv. 0 · (Alias di Randello Incantato / Shillelagh) Il legno di una clava o bastone usa la caratteristica da incantatore e infligge 1d8.',
  ...
  'Colpo Sicuro': 'Ottieni vantaggio al tuo prossimo tiro per colpire o usi la caratteristica da incantatore.',
  ...
  'Derisione Crudele': 'Un insulto magico (gittata 18 m): 1d6 psichici e svantaggio al prossimo attacco (TS Saggezza).',
  ...
  'Ferma il Tempo': 'Liv. 9 · Blocchi il flusso del tempo per 1d4+1 round per chiunque tranne te.',
  ...
  'Raffica Occulta': 'Attacco magico a distanza (gittata 36 m): 1d10 forza per raggio; 2 raggi a liv. 5, 3 a liv. 11, 4 a liv. 17.',
  ...
  'Resurrezione Vera': 'Liv. 9 · Riporti in vita qualsiasi creatura morta a PF massimi, curando ogni male, anche senza corpo (25.000 mo).',
  ...
  'Rintocco Funebre': 'Un rintocco su un bersaglio entro 18 m: 1d8 necrotici, 1d12 se è già ferito (TS Saggezza; aumenta a 5/11/17).',
  ...
  'Spruzzo di Veleno': 'Un soffio tossico su un bersaglio entro 3 m: 1d12 veleno (TS Costituzione; aumenta a 5/11/17).',
  ...
  'Tocco Folgorante': 'Attacco magico in mischia (gittata tocco): 1d8 fulmine e niente reazioni fino al suo prossimo turno (aumenta a 5/11/17).',
  ...
  'Zampata Acida': "Una bolla d'acido su 1-2 bersagli vicini (gittata 18 m): 1d6 acido (aumenta a 5/11/17).",
