...
const SPIEG_INCANTESIMI = {
  ...
  'Randello Incantato': 'Liv. 0 · Il legno di una clava o bastone ferrato che impugni viene intriso di magia per 1 minuto: usi la caratteristica da incantatore al posto della Forza per tiri per colpire e danni, il danno dell\'arma diventa 1d8 (contundente) e diventa magica. Termina se lasci andare l\'arma.',
  'Bastone Incantato': 'Liv. 0 · (Nome comune/alias ufficiale: Randello Incantato / Shillelagh) Il legno di una clava o bastone ferrato usa la caratteristica da incantatore per attacco e danni (1d8 contundente) e diventa magico per 1 minuto.',
