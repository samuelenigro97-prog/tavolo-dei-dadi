...
const SPIEG_INCANTESIMI = {
  'Aggiustare': 'Ripari un oggetto rotto o una crepa non più larga di ~30 cm (tocco, istantaneo). (Alias di Riparare / Mending)',
  ...
  'Arte Druidica': 'Piccoli effetti naturali: prevedere il meteo 24 h, far sbocciare un fiore, creare un simbolo di fumo. (Alias di Artificio Druidico)',
  ...
  'Camminare sull’Acqua': 'Liv. 3 · (Alias di Camminare sull\'Acqua) Fino a 10 creature camminano su superfici liquide per 1 ora. Rituale.',
  ...
  'Colpo Sicuro': 'Ottieni vantaggio al tuo prossimo tiro per colpire o usi la caratteristica da incantatore. (Alias di Colpo Accurato)',
  ...
  'Derisione Crudele': 'Un insulto magico (gittata 18 m): 1d6 psichici e svantaggio al prossimo attacco (TS Saggezza). (Alias di Beffa Crudele)',
  ...
  'Evoca Animali': 'Liv. 3 · (Alias di Evocare Animali) Evochi spiriti animali fedeli che combattono per te (gittata 18 m). Concentrazione, 10 min.',
  'Evocare Animali': 'Liv. 3 · Evochi spiriti animali fedeli che combattono per te (gittata 18 m). Concentrazione, 10 min.',
  'Evoca Elementale': 'Liv. 5 · (Alias di Evocare Elementale) Evochi uno spirito elementale (aria/terra/fuoco/acqua) di GS ≤5 che combatte per te. Concentrazione, 1 ora.',
  ...
  'Ferma il Tempo': 'Liv. 9 · Blocchi il flusso del tempo per 1d4+1 round per chiunque tranne te. (Alias di Fermare il Tempo)',
  ...
  'Parola Guaritrice': 'Liv. 1 · (Alias di Parola di Guarigione / Healing Word) Come azione bonus curi una creatura entro 18 m.',
  ...
  'Passo Senza Tracce': 'Liv. 2 · Tu e gli alleati vicini avete +10 a Furtività e non lasciate tracce. Concentrazione, 1 ora. (Alias di Passare Senza Tracce)',
  ...
  'Polimorfia': 'Liv. 4 · Trasformi una creatura (gittata 18 m; TS Saggezza) in una bestia con PF propri. Concentrazione, 1 ora. (Alias di Metamorfosi)',
  ...
  'Protezione dal Veleno': 'Liv. 2 · Neutralizzi un veleno; per 1 ora la creatura ha resistenza al veleno e vantaggio ai TS contro il veleno (tocco). (Alias di Protezione dai Veleni)',
  ...
  'Raffica Occulta': 'Attacco magico a distanza (gittata 36 m): 1d10 forza per raggio; 2 raggi a liv. 5, 3 a liv. 11, 4 a liv. 17. (Alias di Deflagrazione Occulta)',
  ...
  'Raggio dell’Indebolimento': 'Liv. 2 · Un raggio (gittata 18 m; TS Costituzione) dimezza i danni delle armi basate sulla Forza del bersaglio. Concentrazione, 1 min. (Alias di Raggio di Indebolimento)',
  ...
  'Respirare sott’acqua': "Liv. 3 · Fino a 10 creature respirano sott'acqua per 24 ore. Rituale. (Alias di Respirare sott'Acqua)",
  ...
  'Resurrezione Vera': 'Liv. 9 · Riporti in vita qualsiasi creatura morta a PF massimi, curando ogni male, anche senza corpo (25.000 mo). (Alias di Resurrezione Pura)',
  ...
  'Rintocco Funebre': 'Un rintocco su un bersaglio entro 18 m: 1d8 necrotici, 1d12 se è già ferito (TS Saggezza; aumenta a 5/11/17). (Alias di Rintocco dei Morti)',
  ...
  'Scassinare': 'Liv. 2 · (Alias di Bussare / Knock) Apri magicamente una serratura, lucchetto o porta sbarrata entro 18 m. Istantaneo.',
  ...
  'Trama Ipnotica': 'Liv. 3 · (Alias di Schema Ipnotico / Hypnotic Pattern) Area 9 m (gittata 36 m): le creature restano affascinate e incapacitate (TS Saggezza). Concentrazione, 1 min.',
  ...
  'Spruzzo di Veleno': 'Un soffio tossico su un bersaglio entro 3 m: 1d12 veleno (TS Costituzione; aumenta a 5/11/17). (Alias di Spruzzo Velenoso)',
  ...
  'Tocco Folgorante': 'Attacco magico in mischia (gittata tocco): 1d8 fulmine e niente reazioni fino al suo prossimo turno (aumenta a 5/11/17). (Alias di Stretta Folgorante)',
  ...
  'Zampata Acida': "Una bolla d'acido su 1-2 bersagli vicini (gittata 18 m): 1d6 acido (aumenta a 5/11/17). (Alias di Spruzzo Acido)",
